...
# Create a unique matching key in the Tokens DataFrame
...
'''merged_df = pd.merge(
    memberships_df, 
    draft_merge, 
    on=['Name_Key','Group ID'],
    how='left'
)'''
#adds last 4 digits from draft export that correspond to matching names in memberships

#print(merged_df['Last 4 Digits'].isnull().sum())
